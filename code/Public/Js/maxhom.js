...
function area_change(id,level,province,city,area,town,village,provinceid,cityid,areaid,townid,villageid){
	
	var datas={'level':level,'provinceid':provinceid,'cityid':cityid,'areaid':areaid,'townid':townid};
	$.ajax({
		type:"POST",
