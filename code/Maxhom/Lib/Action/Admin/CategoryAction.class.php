...
class CategoryAction extends AdminbaseAction
{
	...
	public function _before_add()
    {
		...
		$maxhom_auth = authcode('1-1-0-1-jpeg,jpg,png,gif-3-0', 'ENCODE',$maxhom_auth_key);
		$this->assign('maxhom_auth',$maxhom_auth);
	...
	public function delete() {
		...
		$tmodule = $this->categorys[$catid]['module'];
