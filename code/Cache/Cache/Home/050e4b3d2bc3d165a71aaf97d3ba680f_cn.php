 ...
 $slist = M("Product")->order("rand()")->limit(10)->select(); foreach($slist as $srs){ ?>
    ...
    <div class="right">
      <div class="sitemp clearfix">
        <h2>下载资料 </h2>
        <div class="site">您的当前位置： <a href="/">首 页</a>>>
      ...
      <div class="content">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><p style="line-height: 16px;">
		  <img style="vertical-align: middle; margin-right: 2px;" src="/static/picture/icon_doc.gif"/>
		  <a style="font-size:12px; color:#0066cc;" href="<?php echo ($r["file"]); ?>" title="M-6100" > <?php echo ($r["title"]); ?></a></p>
