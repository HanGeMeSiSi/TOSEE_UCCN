...
<title><?php echo L('system_name');?> Powered by Maxhom</title>
...
<div class="login_box">
	...
	<div class="login_left" style="font-size:50px; font-weight:bold; padding-top:56px; color:#FB7209">
	<?php echo L('system_realname');?>
	</div>
	...
	<div class="login_right">
		...
		<div class="login_form">
			...
			<?php if($admin_verify) : ?>
			<li><label><?php echo L('verify');?>:</label><input name="verifyCode" class="input-text"  class="inputbox" id="verifyCode"  size="6" value="" maxlength="4" /><img src="<?php echo U('Home/Index/verify');?>" onclick="javascript:resetVerifyCode();" class="checkcode" align="absmiddle"  title="<?php echo L('resetVerifyCode');?>" id="verifyImage"/></li><?php endif;?>
